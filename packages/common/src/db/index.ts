import type * as p from '@jshare/prisma';
...
export namespace DB {
    ...
    export type GroupParticipant<I extends p.Prisma.GroupParticipantInclude | undefined> =
        I extends undefined
            ? p.GroupParticipant
            : p.Prisma.GroupParticipantGetPayload<{ include: I }>;

    export type Image<I extends p.Prisma.ImageInclude | undefined> = I extends undefined
        ? p.Image
        : p.Prisma.ImageGetPayload<{ include: I }>;

    export type Message<I extends p.Prisma.MessageInclude | undefined> = I extends undefined
        ? p.Message
        : p.Prisma.MessageGetPayload<{ include: I }>;

    export type Expense<I extends p.Prisma.ExpenseInclude | undefined> = I extends undefined
        ? p.Expense
        : p.Prisma.ExpenseGetPayload<{ include: I }>;

    export type ExpenseShare<I extends p.Prisma.ExpenseShareInclude | undefined> =
