...
const GroupUpdateOneWithoutCoverImageNestedInput_schema_1 = require("./GroupUpdateOneWithoutCoverImageNestedInput.schema");
const ProfileUpdateOneWithoutAvatarNestedInput_schema_1 = require("./ProfileUpdateOneWithoutAvatarNestedInput.schema");
exports.ImageUpdateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), Group: zod_1.z.lazy(() => GroupUpdateOneWithoutCoverImageNestedInput_schema_1.GroupUpdateOneWithoutCoverImageNestedInputObjectSchema).optional(), Profile: zod_1.z.lazy(() => ProfileUpdateOneWithoutAvatarNestedInput_schema_1.ProfileUpdateOneWithoutAvatarNestedInputObjectSchema).optional()
}).strict();
