...
exports.MessageSelectObjectSchema = zod_1.z.object({
    id: zod_1.z.boolean().optional(), archived: zod_1.z.boolean().optional(), createdAt: zod_1.z.boolean().optional(), updatedAt: zod_1.z.boolean().optional(), key: zod_1.z.boolean().optional(), text: zod_1.z.boolean().optional(), authorType: zod_1.z.boolean().optional(), authorId: zod_1.z.boolean().optional(), author: zod_1.z.union([zod_1.z.boolean(),
