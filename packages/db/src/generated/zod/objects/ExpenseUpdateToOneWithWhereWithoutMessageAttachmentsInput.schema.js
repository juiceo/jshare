...
exports.ExpenseUpdateToOneWithWhereWithoutMessageAttachmentsInputObjectSchema = zod_1.z.object({
    where: zod_1.z.lazy(() => ExpenseWhereInput_schema_1.ExpenseWhereInputObjectSchema).optional().optional(), data: zod_1.z.union([zod_1.z.lazy(() => ExpenseUpdateWithoutMessageAttachmentsInput_schema_1.ExpenseUpdateWithoutMessageAttachmentsInputObjectSchema), zod_1.z.lazy(() => ExpenseUncheckedUpdateWithoutMessageAttachmentsInput_schema_1.ExpenseUncheckedUpdateWithoutMessageAttachmentsInputObjectSchema)])
}).strict();
