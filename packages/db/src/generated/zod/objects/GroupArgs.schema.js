...
exports.GroupArgsObjectSchema = zod_1.z.object({
    select: zod_1.z.lazy(() => GroupSelect_schema_1.GroupSelectObjectSchema).optional(), include: zod_1.z.lazy(() => GroupInclude_schema_1.GroupIncludeObjectSchema).optional()
}).strict();
