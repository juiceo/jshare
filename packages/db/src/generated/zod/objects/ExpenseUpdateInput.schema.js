...
exports.ExpenseUpdateInputObjectSchema = void 0;
// @ts-nocheck
...
const ExpenseShareUpdateManyWithoutExpenseNestedInput_schema_1 = require("./ExpenseShareUpdateManyWithoutExpenseNestedInput.schema");
...
exports.ExpenseUpdateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), conversion: zod_1.z.lazy(() => CurrencyConversion_schema_1.CurrencyConversionSchema), owner: zod_1.z.lazy(() => ProfileUpdateOneRequiredWithoutExpensesOwnedNestedInput_schema_1.ProfileUpdateOneRequiredWithoutExpensesOwnedNestedInputObjectSchema).optional(), payer: zod_1.z.lazy(() => ProfileUpdateOneRequiredWithoutExpensesPaidNestedInput_schema_1.ProfileUpdateOneRequiredWithoutExpensesPaidNestedInputObjectSchema).optional(), group: zod_1.z.lazy(() => GroupUpdateOneRequiredWithoutExpensesNestedInput_schema_1.GroupUpdateOneRequiredWithoutExpensesNestedInputObjectSchema).optional(), shares: zod_1.z.lazy(() => ExpenseShareUpdateManyWithoutExpenseNestedInput_schema_1.ExpenseShareUpdateManyWithoutExpenseNestedInputObjectSchema).optional(), messageAttachments: zod_1.z.lazy(() => MessageAttachmentUpdateManyWithoutExpenseNestedInput_schema_1.MessageAttachmentUpdateManyWithoutExpenseNestedInputObjectSchema).optional()
}).strict();
