...
exports.MessageCreateWithoutAuthorInputObjectSchema = void 0;
// @ts-nocheck
...
exports.MessageCreateWithoutAuthorInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), archived: zod_1.z.boolean().optional(), archivedAt: zod_1.z.union([zod_1.z.union([zod_1.z.date(), zod_1.z.string().datetime().optional()]),
        ...
        zod_1.z.null()]).optional().nullable(), authorType: zod_1.z.lazy(() => AuthorType_schema_1.AuthorTypeSchema), group: zod_1.z.lazy(() => GroupCreateNestedOneWithoutMessagesInput_schema_1.GroupCreateNestedOneWithoutMessagesInputObjectSchema), attachments: zod_1.z.lazy(() => MessageAttachmentCreateNestedManyWithoutMessageInput_schema_1.MessageAttachmentCreateNestedManyWithoutMessageInputObjectSchema).optional()
}).strict();
