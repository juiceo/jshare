...
exports.ExpenseCreateNestedOneWithoutSharesInputObjectSchema = zod_1.z.object({
    create: zod_1.z.union([zod_1.z.lazy(() => ExpenseCreateWithoutSharesInput_schema_1.ExpenseCreateWithoutSharesInputObjectSchema), zod_1.z.lazy(() => ExpenseUncheckedCreateWithoutSharesInput_schema_1.ExpenseUncheckedCreateWithoutSharesInputObjectSchema)]).optional(), connectOrCreate: zod_1.z.lazy(() => ExpenseCreateOrConnectWithoutSharesInput_schema_1.ExpenseCreateOrConnectWithoutSharesInputObjectSchema).optional(), connect: zod_1.z.lazy(() => ExpenseWhereUniqueInput_schema_1.ExpenseWhereUniqueInputObjectSchema).optional()
}).strict();
