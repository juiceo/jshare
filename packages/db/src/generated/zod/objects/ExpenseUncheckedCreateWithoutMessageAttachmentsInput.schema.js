...
exports.ExpenseUncheckedCreateWithoutMessageAttachmentsInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), archived: zod_1.z.boolean().optional(), archivedAt: zod_1.z.union([zod_1.z.union([zod_1.z.date(), zod_1.z.string().datetime().optional()]),
        ...
        zod_1.z.null()]).optional().nullable(), conversion: zod_1.z.lazy(() => CurrencyConversion_schema_1.CurrencyConversionSchema), shares: zod_1.z.lazy(() => ExpenseShareUncheckedCreateNestedManyWithoutExpenseInput_schema_1.ExpenseShareUncheckedCreateNestedManyWithoutExpenseInputObjectSchema).optional()
}).strict();
