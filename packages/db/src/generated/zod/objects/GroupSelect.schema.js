...
exports.GroupSelectObjectSchema = zod_1.z.object({
    id: zod_1.z.boolean().optional().optional(), archived: zod_1.z.boolean().optional().optional(), archivedAt: zod_1.z.boolean().optional().optional(), createdAt: zod_1.z.boolean().optional().optional(), updatedAt: zod_1.z.boolean().optional().optional(), name: zod_1.z.boolean().optional().optional(), currency: zod_1.z.boolean().optional().optional(), participants: zod_1.z.union([zod_1.z.boolean(),
        zod_1.z.lazy(() => GroupParticipantInput_schema_1.GroupParticipantInputSchema.findMany)]).optional(), coverImageId: zod_1.z.boolean().optional().optional(), coverImage: zod_1.z.union([zod_1.z.boolean(),
        zod_1.z.lazy(() => ImageArgs_schema_1.ImageArgsObjectSchema)]).optional(), inviteCode: zod_1.z.boolean().optional().optional(), messages: zod_1.z.union([zod_1.z.boolean(),
        ...
        zod_1.z.lazy(() => PaymentInput_schema_1.PaymentInputSchema.findMany)]).optional(), lastActivity: zod_1.z.boolean().optional().optional(), _count: zod_1.z.union([zod_1.z.boolean(),
