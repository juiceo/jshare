...
exports.ProfileCreateNestedOneWithoutExpenseSharesInputObjectSchema = zod_1.z.object({
    create: zod_1.z.union([zod_1.z.lazy(() => ProfileCreateWithoutExpenseSharesInput_schema_1.ProfileCreateWithoutExpenseSharesInputObjectSchema), zod_1.z.lazy(() => ProfileUncheckedCreateWithoutExpenseSharesInput_schema_1.ProfileUncheckedCreateWithoutExpenseSharesInputObjectSchema)]).optional(), connectOrCreate: zod_1.z.lazy(() => ProfileCreateOrConnectWithoutExpenseSharesInput_schema_1.ProfileCreateOrConnectWithoutExpenseSharesInputObjectSchema).optional(), connect: zod_1.z.lazy(() => ProfileWhereUniqueInput_schema_1.ProfileWhereUniqueInputObjectSchema).optional()
}).strict();
