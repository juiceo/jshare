...
exports.MessageUpdateWithoutAttachmentsInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.lazy(() => EnumAuthorTypeFieldUpdateOperationsInput_schema_1.EnumAuthorTypeFieldUpdateOperationsInputObjectSchema)]).optional(), author: zod_1.z.lazy(() => ProfileUpdateOneWithoutMessagesNestedInput_schema_1.ProfileUpdateOneWithoutMessagesNestedInputObjectSchema).optional(), group: zod_1.z.lazy(() => GroupUpdateOneRequiredWithoutMessagesNestedInput_schema_1.GroupUpdateOneRequiredWithoutMessagesNestedInputObjectSchema).optional()
}).strict();
