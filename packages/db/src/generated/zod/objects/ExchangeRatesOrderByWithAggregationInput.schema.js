...
exports.ExchangeRatesOrderByWithAggregationInputObjectSchema = zod_1.z.object({
    id: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(), createdAt: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(), updatedAt: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(), baseCurrency: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(), rates: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(), _count: zod_1.z.lazy(() => ExchangeRatesCountOrderByAggregateInput_schema_1.ExchangeRatesCountOrderByAggregateInputObjectSchema).optional(), _max: zod_1.z.lazy(() => ExchangeRatesMaxOrderByAggregateInput_schema_1.ExchangeRatesMaxOrderByAggregateInputObjectSchema).optional(), _min: zod_1.z.lazy(() => ExchangeRatesMinOrderByAggregateInput_schema_1.ExchangeRatesMinOrderByAggregateInputObjectSchema).optional()
}).strict();
