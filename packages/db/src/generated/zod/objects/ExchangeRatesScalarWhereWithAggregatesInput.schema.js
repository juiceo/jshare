...
exports.ExchangeRatesScalarWhereWithAggregatesInputObjectSchema = zod_1.z.object({
    AND: zod_1.z.union([zod_1.z.lazy(() => exports.ExchangeRatesScalarWhereWithAggregatesInputObjectSchema),
        zod_1.z.lazy(() => exports.ExchangeRatesScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), OR: zod_1.z.lazy(() => exports.ExchangeRatesScalarWhereWithAggregatesInputObjectSchema).array().optional().optional(), NOT: zod_1.z.union([zod_1.z.lazy(() => exports.ExchangeRatesScalarWhereWithAggregatesInputObjectSchema),
        ...
        zod_1.z.string()]).optional(), rates: zod_1.z.lazy(() => JsonWithAggregatesFilter_schema_1.JsonWithAggregatesFilterObjectSchema).optional().optional()
}).strict();
