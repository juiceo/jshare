...
exports.ExpenseSelectObjectSchema = zod_1.z.object({
    id: zod_1.z.boolean().optional().optional(), archived: zod_1.z.boolean().optional().optional(), archivedAt: zod_1.z.boolean().optional().optional(), createdAt: zod_1.z.boolean().optional().optional(), updatedAt: zod_1.z.boolean().optional().optional(), ownerId: zod_1.z.boolean().optional().optional(), owner: zod_1.z.union([zod_1.z.boolean(),
        ...
        zod_1.z.lazy(() => GroupArgs_schema_1.GroupArgsObjectSchema)]).optional(), amount: zod_1.z.boolean().optional().optional(), currency: zod_1.z.boolean().optional().optional(), description: zod_1.z.boolean().optional().optional(), conversion: zod_1.z.boolean().optional().optional(), shares: zod_1.z.union([zod_1.z.boolean(),
