...
exports.ProfileCreateWithoutGroupsInputObjectSchema = void 0;
// @ts-nocheck
...
exports.ProfileCreateWithoutGroupsInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional().optional(), archived: zod_1.z.boolean().optional().optional(), archivedAt: zod_1.z.union([zod_1.z.union([zod_1.z.date(), zod_1.z.string().datetime().optional()]),
        ...
        zod_1.z.null()]).optional().nullable(), showInSearch: zod_1.z.boolean().optional().optional(), avatar: zod_1.z.lazy(() => ImageCreateNestedOneWithoutProfileInput_schema_1.ImageCreateNestedOneWithoutProfileInputObjectSchema).optional().optional(), messages: zod_1.z.lazy(() => MessageCreateNestedManyWithoutAuthorInput_schema_1.MessageCreateNestedManyWithoutAuthorInputObjectSchema).optional().optional(), expensesOwned: zod_1.z.lazy(() => ExpenseCreateNestedManyWithoutOwnerInput_schema_1.ExpenseCreateNestedManyWithoutOwnerInputObjectSchema).optional().optional(), expensesPaid: zod_1.z.lazy(() => ExpenseCreateNestedManyWithoutPayerInput_schema_1.ExpenseCreateNestedManyWithoutPayerInputObjectSchema).optional().optional(), expenseShares: zod_1.z.lazy(() => ExpenseShareCreateNestedManyWithoutUserInput_schema_1.ExpenseShareCreateNestedManyWithoutUserInputObjectSchema).optional().optional(), paymentsReceived: zod_1.z.lazy(() => PaymentCreateNestedManyWithoutRecipientInput_schema_1.PaymentCreateNestedManyWithoutRecipientInputObjectSchema).optional().optional(), paymentsPaid: zod_1.z.lazy(() => PaymentCreateNestedManyWithoutPayerInput_schema_1.PaymentCreateNestedManyWithoutPayerInputObjectSchema).optional().optional()
}).strict();
