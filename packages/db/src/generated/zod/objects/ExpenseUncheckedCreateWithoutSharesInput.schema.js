...
exports.ExpenseUncheckedCreateWithoutSharesInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional().optional(), archived: zod_1.z.boolean().optional().optional(), archivedAt: zod_1.z.union([zod_1.z.union([zod_1.z.date(), zod_1.z.string().datetime().optional()]),
        ...
        zod_1.z.null()]).optional().nullable(), conversion: zod_1.z.lazy(() => CurrencyConversion_schema_1.CurrencyConversionSchema).optional(), messageAttachments: zod_1.z.lazy(() => MessageAttachmentUncheckedCreateNestedManyWithoutExpenseInput_schema_1.MessageAttachmentUncheckedCreateNestedManyWithoutExpenseInputObjectSchema).optional().optional()
}).strict();
