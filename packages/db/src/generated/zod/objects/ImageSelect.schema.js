...
exports.ImageSelectObjectSchema = zod_1.z.object({
    id: zod_1.z.boolean().optional(), archived: zod_1.z.boolean().optional(), createdAt: zod_1.z.boolean().optional(), updatedAt: zod_1.z.boolean().optional(), path: zod_1.z.boolean().optional(), bucket: zod_1.z.boolean().optional(), uploadedById: zod_1.z.boolean().optional(), blurhash: zod_1.z.boolean().optional(), Group: zod_1.z.union([zod_1.z.boolean(),
