...
exports.ImageUncheckedUpdateWithoutGroupInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), Profile: zod_1.z.lazy(() => ProfileUncheckedUpdateOneWithoutAvatarNestedInput_schema_1.ProfileUncheckedUpdateOneWithoutAvatarNestedInputObjectSchema).optional()
}).strict();
