...
exports.ExpenseUpdateWithoutOwnerInputObjectSchema = void 0;
// @ts-nocheck
...
exports.ExpenseUpdateWithoutOwnerInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), conversion: zod_1.z.lazy(() => CurrencyConversion_schema_1.CurrencyConversionSchema).optional(), payer: zod_1.z.lazy(() => ProfileUpdateOneRequiredWithoutExpensesPaidNestedInput_schema_1.ProfileUpdateOneRequiredWithoutExpensesPaidNestedInputObjectSchema).optional().optional(), group: zod_1.z.lazy(() => GroupUpdateOneRequiredWithoutExpensesNestedInput_schema_1.GroupUpdateOneRequiredWithoutExpensesNestedInputObjectSchema).optional().optional(), shares: zod_1.z.lazy(() => ExpenseShareUpdateManyWithoutExpenseNestedInput_schema_1.ExpenseShareUpdateManyWithoutExpenseNestedInputObjectSchema).optional().optional(), messageAttachments: zod_1.z.lazy(() => MessageAttachmentUpdateManyWithoutExpenseNestedInput_schema_1.MessageAttachmentUpdateManyWithoutExpenseNestedInputObjectSchema).optional().optional()
}).strict();
