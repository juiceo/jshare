...
exports.ImageUncheckedCreateWithoutProfileInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), archived: zod_1.z.boolean().optional(), archivedAt: zod_1.z.union([zod_1.z.union([zod_1.z.date(), zod_1.z.string().datetime().optional()]),
        ...
        zod_1.z.null()]).optional().nullable(), Group: zod_1.z.lazy(() => GroupUncheckedCreateNestedOneWithoutCoverImageInput_schema_1.GroupUncheckedCreateNestedOneWithoutCoverImageInputObjectSchema).optional()
}).strict();
