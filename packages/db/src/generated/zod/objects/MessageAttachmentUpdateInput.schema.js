...
exports.MessageAttachmentUpdateInputObjectSchema = void 0;
// @ts-nocheck
...
const MessageUpdateOneRequiredWithoutAttachmentsNestedInput_schema_1 = require("./MessageUpdateOneRequiredWithoutAttachmentsNestedInput.schema");
const ExpenseUpdateOneWithoutMessageAttachmentsNestedInput_schema_1 = require("./ExpenseUpdateOneWithoutMessageAttachmentsNestedInput.schema");
exports.MessageAttachmentUpdateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.lazy(() => EnumMessageAttachmentTypeFieldUpdateOperationsInput_schema_1.EnumMessageAttachmentTypeFieldUpdateOperationsInputObjectSchema)]).optional(), message: zod_1.z.lazy(() => MessageUpdateOneRequiredWithoutAttachmentsNestedInput_schema_1.MessageUpdateOneRequiredWithoutAttachmentsNestedInputObjectSchema).optional().optional(), expense: zod_1.z.lazy(() => ExpenseUpdateOneWithoutMessageAttachmentsNestedInput_schema_1.ExpenseUpdateOneWithoutMessageAttachmentsNestedInputObjectSchema).optional().optional()
}).strict();
