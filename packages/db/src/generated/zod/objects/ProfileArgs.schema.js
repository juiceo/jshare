...
exports.ProfileArgsObjectSchema = zod_1.z.object({
    select: zod_1.z.lazy(() => ProfileSelect_schema_1.ProfileSelectObjectSchema).optional().optional(), include: zod_1.z.lazy(() => ProfileInclude_schema_1.ProfileIncludeObjectSchema).optional().optional()
}).strict();
