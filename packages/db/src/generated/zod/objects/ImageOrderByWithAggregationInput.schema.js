...
exports.ImageOrderByWithAggregationInputObjectSchema = zod_1.z.object({
    id: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional().optional(), archived: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional().optional(), archivedAt: zod_1.z.union([zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema),
        ...
        zod_1.z.lazy(() => SortOrderInput_schema_1.SortOrderInputObjectSchema)]).optional(), _count: zod_1.z.lazy(() => ImageCountOrderByAggregateInput_schema_1.ImageCountOrderByAggregateInputObjectSchema).optional().optional(), _max: zod_1.z.lazy(() => ImageMaxOrderByAggregateInput_schema_1.ImageMaxOrderByAggregateInputObjectSchema).optional().optional(), _min: zod_1.z.lazy(() => ImageMinOrderByAggregateInput_schema_1.ImageMinOrderByAggregateInputObjectSchema).optional().optional()
}).strict();
