...
exports.MessageUncheckedCreateWithoutGroupInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional().optional(), archived: zod_1.z.boolean().optional().optional(), archivedAt: zod_1.z.union([zod_1.z.union([zod_1.z.date(), zod_1.z.string().datetime().optional()]),
        ...
        zod_1.z.null()]).optional().nullable(), attachments: zod_1.z.lazy(() => MessageAttachmentUncheckedCreateNestedManyWithoutMessageInput_schema_1.MessageAttachmentUncheckedCreateNestedManyWithoutMessageInputObjectSchema).optional().optional()
}).strict();
