...
exports.ProfileUncheckedCreateWithoutExpensesPaidInputObjectSchema = void 0;
// @ts-nocheck
...
exports.ProfileUncheckedCreateWithoutExpensesPaidInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string(), userId: zod_1.z.string(), email: zod_1.z.string(), firstName: zod_1.z.string(), lastName: zod_1.z.string(), lastActivity: zod_1.z.union([zod_1.z.date().optional(), zod_1.z.string().datetime().optional()]), currency: zod_1.z.lazy(() => CurrencyCode_schema_1.CurrencyCodeSchema), avatarId: zod_1.z.union([zod_1.z.string(),
