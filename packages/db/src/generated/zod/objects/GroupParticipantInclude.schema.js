...
exports.GroupParticipantIncludeObjectSchema = void 0;
// @ts-nocheck
const zod_1 = require("zod");
const ProfileArgs_schema_1 = require("./ProfileArgs.schema");
const GroupArgs_schema_1 = require("./GroupArgs.schema");
exports.GroupParticipantIncludeObjectSchema = zod_1.z.object({
    user: zod_1.z.union([zod_1.z.boolean(),
        ...
        zod_1.z.lazy(() => GroupArgs_schema_1.GroupArgsObjectSchema)]).optional()
}).strict();
