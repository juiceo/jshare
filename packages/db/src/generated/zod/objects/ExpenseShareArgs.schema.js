...
exports.ExpenseShareArgsObjectSchema = zod_1.z.object({
    select: zod_1.z.lazy(() => ExpenseShareSelect_schema_1.ExpenseShareSelectObjectSchema).optional().optional(), include: zod_1.z.lazy(() => ExpenseShareInclude_schema_1.ExpenseShareIncludeObjectSchema).optional().optional()
}).strict();
