...
exports.ImageArgsObjectSchema = zod_1.z.object({
    select: zod_1.z.lazy(() => ImageSelect_schema_1.ImageSelectObjectSchema).optional().optional(), include: zod_1.z.lazy(() => ImageInclude_schema_1.ImageIncludeObjectSchema).optional().optional()
}).strict();
