...
exports.ExpenseShareScalarWhereInputObjectSchema = zod_1.z.object({
    AND: zod_1.z.union([zod_1.z.lazy(() => exports.ExpenseShareScalarWhereInputObjectSchema),
        zod_1.z.lazy(() => exports.ExpenseShareScalarWhereInputObjectSchema).array()]).optional(), OR: zod_1.z.lazy(() => exports.ExpenseShareScalarWhereInputObjectSchema).array().optional().optional(), NOT: zod_1.z.union([zod_1.z.lazy(() => exports.ExpenseShareScalarWhereInputObjectSchema),
        ...
        zod_1.z.boolean()]).optional(), conversion: zod_1.z.lazy(() => JsonNullableFilter_schema_1.JsonNullableFilterObjectSchema).optional().optional()
}).strict();
