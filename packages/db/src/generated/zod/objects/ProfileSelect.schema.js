...
exports.ProfileSelectObjectSchema = zod_1.z.object({
    id: zod_1.z.boolean().optional(), archived: zod_1.z.boolean().optional(), archivedAt: zod_1.z.boolean().optional(), createdAt: zod_1.z.boolean().optional(), updatedAt: zod_1.z.boolean().optional(), email: zod_1.z.boolean().optional(), firstName: zod_1.z.boolean().optional(), lastName: zod_1.z.boolean().optional(), lastActivity: zod_1.z.boolean().optional(), currency: zod_1.z.boolean().optional(), groups: zod_1.z.union([zod_1.z.boolean(),
