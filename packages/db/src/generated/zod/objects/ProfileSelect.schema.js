...
exports.ProfileSelectObjectSchema = zod_1.z.object({
    userId: zod_1.z.boolean().optional(), email: zod_1.z.boolean().optional(), firstName: zod_1.z.boolean().optional(), lastName: zod_1.z.boolean().optional(), currency: zod_1.z.boolean().optional(), groups: zod_1.z.union([zod_1.z.boolean(),
