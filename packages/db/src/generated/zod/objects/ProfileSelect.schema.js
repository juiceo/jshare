...
exports.ProfileSelectObjectSchema = zod_1.z.object({
    id: zod_1.z.boolean().optional().optional(), archived: zod_1.z.boolean().optional().optional(), archivedAt: zod_1.z.boolean().optional().optional(), createdAt: zod_1.z.boolean().optional().optional(), updatedAt: zod_1.z.boolean().optional().optional(), email: zod_1.z.boolean().optional().optional(), firstName: zod_1.z.boolean().optional().optional(), lastName: zod_1.z.boolean().optional().optional(), lastActivity: zod_1.z.boolean().optional().optional(), currency: zod_1.z.boolean().optional().optional(), groups: zod_1.z.union([zod_1.z.boolean(),
        zod_1.z.lazy(() => GroupParticipantInput_schema_1.GroupParticipantInputSchema.findMany)]).optional(), avatarId: zod_1.z.boolean().optional().optional(), avatar: zod_1.z.union([zod_1.z.boolean(),
        zod_1.z.lazy(() => ImageArgs_schema_1.ImageArgsObjectSchema)]).optional(), temporary: zod_1.z.boolean().optional().optional(), termsAcceptedAt: zod_1.z.boolean().optional().optional(), messages: zod_1.z.union([zod_1.z.boolean(),
        ...
        zod_1.z.lazy(() => PaymentInput_schema_1.PaymentInputSchema.findMany)]).optional(), showInSearch: zod_1.z.boolean().optional().optional(), _count: zod_1.z.union([zod_1.z.boolean(),
