...
exports.NestedDateTimeNullableWithAggregatesFilterObjectSchema = void 0;
// @ts-nocheck
...
exports.NestedDateTimeNullableWithAggregatesFilterObjectSchema = zod_1.z.object({
    equals: zod_1.z.union([zod_1.z.union([zod_1.z.date(), zod_1.z.string().datetime().optional()]),
        ...
        zod_1.z.lazy(() => exports.NestedDateTimeNullableWithAggregatesFilterObjectSchema),
        zod_1.z.null()]).optional().nullable(), _count: zod_1.z.lazy(() => NestedIntNullableFilter_schema_1.NestedIntNullableFilterObjectSchema).optional().optional(), _min: zod_1.z.lazy(() => NestedDateTimeNullableFilter_schema_1.NestedDateTimeNullableFilterObjectSchema).optional().optional(), _max: zod_1.z.lazy(() => NestedDateTimeNullableFilter_schema_1.NestedDateTimeNullableFilterObjectSchema).optional().optional()
}).strict();
