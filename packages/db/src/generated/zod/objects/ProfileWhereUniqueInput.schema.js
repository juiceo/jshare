...
exports.ProfileWhereUniqueInputObjectSchema = void 0;
// @ts-nocheck
...
exports.ProfileWhereUniqueInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional().optional(), avatarId: zod_1.z.string().optional().optional(), AND: zod_1.z.union([zod_1.z.lazy(() => ProfileWhereInput_schema_1.ProfileWhereInputObjectSchema),
        zod_1.z.lazy(() => ProfileWhereInput_schema_1.ProfileWhereInputObjectSchema).array()]).optional(), OR: zod_1.z.lazy(() => ProfileWhereInput_schema_1.ProfileWhereInputObjectSchema).array().optional().optional(), NOT: zod_1.z.union([zod_1.z.lazy(() => ProfileWhereInput_schema_1.ProfileWhereInputObjectSchema),
        ...
        zod_1.z.boolean()]).optional(), groups: zod_1.z.lazy(() => GroupParticipantListRelationFilter_schema_1.GroupParticipantListRelationFilterObjectSchema).optional().optional(), avatar: zod_1.z.union([zod_1.z.lazy(() => ImageNullableScalarRelationFilter_schema_1.ImageNullableScalarRelationFilterObjectSchema),
        zod_1.z.lazy(() => ImageWhereInput_schema_1.ImageWhereInputObjectSchema),
        zod_1.z.null()]).optional().nullable(), messages: zod_1.z.lazy(() => MessageListRelationFilter_schema_1.MessageListRelationFilterObjectSchema).optional().optional(), expensesOwned: zod_1.z.lazy(() => ExpenseListRelationFilter_schema_1.ExpenseListRelationFilterObjectSchema).optional().optional(), expensesPaid: zod_1.z.lazy(() => ExpenseListRelationFilter_schema_1.ExpenseListRelationFilterObjectSchema).optional().optional(), expenseShares: zod_1.z.lazy(() => ExpenseShareListRelationFilter_schema_1.ExpenseShareListRelationFilterObjectSchema).optional().optional(), paymentsReceived: zod_1.z.lazy(() => PaymentListRelationFilter_schema_1.PaymentListRelationFilterObjectSchema).optional().optional(), paymentsPaid: zod_1.z.lazy(() => PaymentListRelationFilter_schema_1.PaymentListRelationFilterObjectSchema).optional().optional()
}).strict();
