...
exports.MessageUncheckedUpdateWithoutGroupInputObjectSchema = void 0;
// @ts-nocheck
...
const MessageAttachmentUncheckedUpdateManyWithoutMessageNestedInput_schema_1 = require("./MessageAttachmentUncheckedUpdateManyWithoutMessageNestedInput.schema");
exports.MessageUncheckedUpdateWithoutGroupInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.lazy(() => NullableStringFieldUpdateOperationsInput_schema_1.NullableStringFieldUpdateOperationsInputObjectSchema),
        zod_1.z.null()]).optional().nullable(), attachments: zod_1.z.lazy(() => MessageAttachmentUncheckedUpdateManyWithoutMessageNestedInput_schema_1.MessageAttachmentUncheckedUpdateManyWithoutMessageNestedInputObjectSchema).optional().optional()
}).strict();
