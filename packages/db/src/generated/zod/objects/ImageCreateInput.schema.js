...
exports.ImageCreateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), archived: zod_1.z.boolean().optional(), archivedAt: zod_1.z.union([zod_1.z.union([zod_1.z.date(), zod_1.z.string().datetime().optional()]),
        ...
        zod_1.z.null()]).optional().nullable(), Group: zod_1.z.lazy(() => GroupCreateNestedOneWithoutCoverImageInput_schema_1.GroupCreateNestedOneWithoutCoverImageInputObjectSchema).optional(), Profile: zod_1.z.lazy(() => ProfileCreateNestedOneWithoutAvatarInput_schema_1.ProfileCreateNestedOneWithoutAvatarInputObjectSchema).optional()
}).strict();
