...
exports.ExchangeRatesWhereUniqueInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional().optional(), AND: zod_1.z.union([zod_1.z.lazy(() => ExchangeRatesWhereInput_schema_1.ExchangeRatesWhereInputObjectSchema),
        zod_1.z.lazy(() => ExchangeRatesWhereInput_schema_1.ExchangeRatesWhereInputObjectSchema).array()]).optional(), OR: zod_1.z.lazy(() => ExchangeRatesWhereInput_schema_1.ExchangeRatesWhereInputObjectSchema).array().optional().optional(), NOT: zod_1.z.union([zod_1.z.lazy(() => ExchangeRatesWhereInput_schema_1.ExchangeRatesWhereInputObjectSchema),
        ...
        zod_1.z.string()]).optional(), rates: zod_1.z.lazy(() => JsonFilter_schema_1.JsonFilterObjectSchema).optional().optional()
}).strict();
