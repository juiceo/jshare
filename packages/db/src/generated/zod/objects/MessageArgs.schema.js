...
exports.MessageArgsObjectSchema = zod_1.z.object({
    select: zod_1.z.lazy(() => MessageSelect_schema_1.MessageSelectObjectSchema).optional(), include: zod_1.z.lazy(() => MessageInclude_schema_1.MessageIncludeObjectSchema).optional()
}).strict();
