...
exports.GroupCreateNestedOneWithoutMessagesInputObjectSchema = zod_1.z.object({
    create: zod_1.z.union([zod_1.z.lazy(() => GroupCreateWithoutMessagesInput_schema_1.GroupCreateWithoutMessagesInputObjectSchema), zod_1.z.lazy(() => GroupUncheckedCreateWithoutMessagesInput_schema_1.GroupUncheckedCreateWithoutMessagesInputObjectSchema)]).optional(), connectOrCreate: zod_1.z.lazy(() => GroupCreateOrConnectWithoutMessagesInput_schema_1.GroupCreateOrConnectWithoutMessagesInputObjectSchema).optional().optional(), connect: zod_1.z.lazy(() => GroupWhereUniqueInput_schema_1.GroupWhereUniqueInputObjectSchema).optional().optional()
}).strict();
