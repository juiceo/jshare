...
exports.ExpenseUncheckedUpdateWithoutSharesInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), conversion: zod_1.z.lazy(() => CurrencyConversion_schema_1.CurrencyConversionSchema).optional(), messageAttachments: zod_1.z.lazy(() => MessageAttachmentUncheckedUpdateManyWithoutExpenseNestedInput_schema_1.MessageAttachmentUncheckedUpdateManyWithoutExpenseNestedInputObjectSchema).optional().optional()
}).strict();
