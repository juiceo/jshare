...
exports.ImageUncheckedUpdateInputObjectSchema = void 0;
// @ts-nocheck
...
const GroupUncheckedUpdateOneWithoutCoverImageNestedInput_schema_1 = require("./GroupUncheckedUpdateOneWithoutCoverImageNestedInput.schema");
const ProfileUncheckedUpdateOneWithoutAvatarNestedInput_schema_1 = require("./ProfileUncheckedUpdateOneWithoutAvatarNestedInput.schema");
exports.ImageUncheckedUpdateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), Group: zod_1.z.lazy(() => GroupUncheckedUpdateOneWithoutCoverImageNestedInput_schema_1.GroupUncheckedUpdateOneWithoutCoverImageNestedInputObjectSchema).optional().optional(), Profile: zod_1.z.lazy(() => ProfileUncheckedUpdateOneWithoutAvatarNestedInput_schema_1.ProfileUncheckedUpdateOneWithoutAvatarNestedInputObjectSchema).optional().optional()
}).strict();
