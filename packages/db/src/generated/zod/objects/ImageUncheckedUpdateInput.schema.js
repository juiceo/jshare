...
const GroupUncheckedUpdateManyWithoutCoverImageNestedInput_schema_1 = require("./GroupUncheckedUpdateManyWithoutCoverImageNestedInput.schema");
const ProfileUncheckedUpdateManyWithoutAvatarNestedInput_schema_1 = require("./ProfileUncheckedUpdateManyWithoutAvatarNestedInput.schema");
exports.ImageUncheckedUpdateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.null()]).optional().nullable(), Group: zod_1.z.lazy(() => GroupUncheckedUpdateManyWithoutCoverImageNestedInput_schema_1.GroupUncheckedUpdateManyWithoutCoverImageNestedInputObjectSchema).optional(), Profile: zod_1.z.lazy(() => ProfileUncheckedUpdateManyWithoutAvatarNestedInput_schema_1.ProfileUncheckedUpdateManyWithoutAvatarNestedInputObjectSchema).optional()
}).strict();
