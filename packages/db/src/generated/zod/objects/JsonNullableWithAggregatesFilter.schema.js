...
exports.JsonNullableWithAggregatesFilterObjectSchema = zod_1.z.object({
    equals: zod_1.z.union([jsonSchema,
        ...
        zod_1.z.lazy(() => JsonNullValueFilter_schema_1.JsonNullValueFilterSchema)]).optional(), _count: zod_1.z.lazy(() => NestedIntNullableFilter_schema_1.NestedIntNullableFilterObjectSchema).optional(), _min: zod_1.z.lazy(() => NestedJsonNullableFilter_schema_1.NestedJsonNullableFilterObjectSchema).optional(), _max: zod_1.z.lazy(() => NestedJsonNullableFilter_schema_1.NestedJsonNullableFilterObjectSchema).optional()
}).strict();
