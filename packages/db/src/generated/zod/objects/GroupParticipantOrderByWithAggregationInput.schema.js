...
exports.GroupParticipantOrderByWithAggregationInputObjectSchema = zod_1.z.object({
    id: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(), createdAt: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(), updatedAt: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(), userId: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(), groupId: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(), role: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(), _count: zod_1.z.lazy(() => GroupParticipantCountOrderByAggregateInput_schema_1.GroupParticipantCountOrderByAggregateInputObjectSchema).optional(), _max: zod_1.z.lazy(() => GroupParticipantMaxOrderByAggregateInput_schema_1.GroupParticipantMaxOrderByAggregateInputObjectSchema).optional(), _min: zod_1.z.lazy(() => GroupParticipantMinOrderByAggregateInput_schema_1.GroupParticipantMinOrderByAggregateInputObjectSchema).optional()
}).strict();
