...
exports.GroupParticipantOrderByWithAggregationInputObjectSchema = zod_1.z.object({
    id: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional().optional(), archived: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional().optional(), archivedAt: zod_1.z.union([zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema),
        ...
        zod_1.z.lazy(() => SortOrderInput_schema_1.SortOrderInputObjectSchema)]).optional(), _count: zod_1.z.lazy(() => GroupParticipantCountOrderByAggregateInput_schema_1.GroupParticipantCountOrderByAggregateInputObjectSchema).optional().optional(), _max: zod_1.z.lazy(() => GroupParticipantMaxOrderByAggregateInput_schema_1.GroupParticipantMaxOrderByAggregateInputObjectSchema).optional().optional(), _min: zod_1.z.lazy(() => GroupParticipantMinOrderByAggregateInput_schema_1.GroupParticipantMinOrderByAggregateInputObjectSchema).optional().optional()
}).strict();
