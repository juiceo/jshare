...
exports.GroupParticipantCreateWithoutUserInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), createdAt: zod_1.z.union([zod_1.z.date().optional(), zod_1.z.string().datetime().optional()]), updatedAt: zod_1.z.union([zod_1.z.date().optional(), zod_1.z.string().datetime().optional()]), role: zod_1.z.lazy(() => Role_schema_1.RoleSchema), group: zod_1.z.lazy(() => GroupCreateNestedOneWithoutParticipantsInput_schema_1.GroupCreateNestedOneWithoutParticipantsInputObjectSchema)
}).strict();
