...
exports.MessageAttachmentUpdateWithoutMessageInputObjectSchema = void 0;
// @ts-nocheck
...
exports.MessageAttachmentUpdateWithoutMessageInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.lazy(() => EnumMessageAttachmentTypeFieldUpdateOperationsInput_schema_1.EnumMessageAttachmentTypeFieldUpdateOperationsInputObjectSchema)]).optional(), expense: zod_1.z.lazy(() => ExpenseUpdateOneWithoutMessageAttachmentsNestedInput_schema_1.ExpenseUpdateOneWithoutMessageAttachmentsNestedInputObjectSchema).optional().optional()
}).strict();
