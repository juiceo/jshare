...
exports.ExpenseArgsObjectSchema = zod_1.z.object({
    select: zod_1.z.lazy(() => ExpenseSelect_schema_1.ExpenseSelectObjectSchema).optional(), include: zod_1.z.lazy(() => ExpenseInclude_schema_1.ExpenseIncludeObjectSchema).optional()
}).strict();
