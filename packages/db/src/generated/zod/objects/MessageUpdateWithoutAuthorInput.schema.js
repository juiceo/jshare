...
exports.MessageUpdateWithoutAuthorInputObjectSchema = void 0;
// @ts-nocheck
...
exports.MessageUpdateWithoutAuthorInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.lazy(() => EnumAuthorTypeFieldUpdateOperationsInput_schema_1.EnumAuthorTypeFieldUpdateOperationsInputObjectSchema)]).optional(), group: zod_1.z.lazy(() => GroupUpdateOneRequiredWithoutMessagesNestedInput_schema_1.GroupUpdateOneRequiredWithoutMessagesNestedInputObjectSchema).optional().optional(), attachments: zod_1.z.lazy(() => MessageAttachmentUpdateManyWithoutMessageNestedInput_schema_1.MessageAttachmentUpdateManyWithoutMessageNestedInputObjectSchema).optional().optional()
}).strict();
