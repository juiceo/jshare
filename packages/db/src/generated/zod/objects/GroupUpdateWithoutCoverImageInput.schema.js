...
exports.GroupUpdateWithoutCoverImageInputObjectSchema = void 0;
// @ts-nocheck
...
exports.GroupUpdateWithoutCoverImageInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.lazy(() => DateTimeFieldUpdateOperationsInput_schema_1.DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(), participants: zod_1.z.lazy(() => GroupParticipantUpdateManyWithoutGroupNestedInput_schema_1.GroupParticipantUpdateManyWithoutGroupNestedInputObjectSchema).optional().optional(), messages: zod_1.z.lazy(() => MessageUpdateManyWithoutGroupNestedInput_schema_1.MessageUpdateManyWithoutGroupNestedInputObjectSchema).optional().optional(), expenses: zod_1.z.lazy(() => ExpenseUpdateManyWithoutGroupNestedInput_schema_1.ExpenseUpdateManyWithoutGroupNestedInputObjectSchema).optional().optional(), payments: zod_1.z.lazy(() => PaymentUpdateManyWithoutGroupNestedInput_schema_1.PaymentUpdateManyWithoutGroupNestedInputObjectSchema).optional().optional()
}).strict();
