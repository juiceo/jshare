...
exports.GroupParticipantArgsObjectSchema = zod_1.z.object({
    select: zod_1.z.lazy(() => GroupParticipantSelect_schema_1.GroupParticipantSelectObjectSchema).optional().optional(), include: zod_1.z.lazy(() => GroupParticipantInclude_schema_1.GroupParticipantIncludeObjectSchema).optional().optional()
}).strict();
