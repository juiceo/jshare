...
exports.ImageUncheckedCreateWithoutGroupInputObjectSchema = zod_1.z.object({
    id: zod_1.z.string().optional(), archived: zod_1.z.union([zod_1.z.boolean(),
        ...
        zod_1.z.null()]).optional().nullable(), Profile: zod_1.z.lazy(() => ProfileUncheckedCreateNestedManyWithoutAvatarInput_schema_1.ProfileUncheckedCreateNestedManyWithoutAvatarInputObjectSchema).optional()
}).strict();
