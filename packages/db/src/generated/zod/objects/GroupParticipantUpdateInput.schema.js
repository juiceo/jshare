...
exports.GroupParticipantUpdateInputObjectSchema = void 0;
// @ts-nocheck
...
const ProfileUpdateOneRequiredWithoutGroupsNestedInput_schema_1 = require("./ProfileUpdateOneRequiredWithoutGroupsNestedInput.schema");
...
exports.GroupParticipantUpdateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.lazy(() => EnumRoleFieldUpdateOperationsInput_schema_1.EnumRoleFieldUpdateOperationsInputObjectSchema)]).optional(), user: zod_1.z.lazy(() => ProfileUpdateOneRequiredWithoutGroupsNestedInput_schema_1.ProfileUpdateOneRequiredWithoutGroupsNestedInputObjectSchema).optional(), group: zod_1.z.lazy(() => GroupUpdateOneRequiredWithoutParticipantsNestedInput_schema_1.GroupUpdateOneRequiredWithoutParticipantsNestedInputObjectSchema).optional()
}).strict();
