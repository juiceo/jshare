...
exports.PaymentUpdateInputObjectSchema = void 0;
// @ts-nocheck
...
const ProfileUpdateOneRequiredWithoutPaymentsReceivedNestedInput_schema_1 = require("./ProfileUpdateOneRequiredWithoutPaymentsReceivedNestedInput.schema");
...
exports.PaymentUpdateInputObjectSchema = zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(),
        ...
        zod_1.z.lazy(() => EnumCurrencyCodeFieldUpdateOperationsInput_schema_1.EnumCurrencyCodeFieldUpdateOperationsInputObjectSchema)]).optional(), conversion: zod_1.z.lazy(() => CurrencyConversion_schema_1.CurrencyConversionSchema).optional(), group: zod_1.z.lazy(() => GroupUpdateOneRequiredWithoutPaymentsNestedInput_schema_1.GroupUpdateOneRequiredWithoutPaymentsNestedInputObjectSchema).optional().optional(), recipient: zod_1.z.lazy(() => ProfileUpdateOneRequiredWithoutPaymentsReceivedNestedInput_schema_1.ProfileUpdateOneRequiredWithoutPaymentsReceivedNestedInputObjectSchema).optional().optional(), payer: zod_1.z.lazy(() => ProfileUpdateOneRequiredWithoutPaymentsPaidNestedInput_schema_1.ProfileUpdateOneRequiredWithoutPaymentsPaidNestedInputObjectSchema).optional().optional()
}).strict();
